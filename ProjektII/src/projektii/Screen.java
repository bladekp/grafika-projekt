...
public class Screen extends JPanel implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener{
	...
	{		
		...
		invisibleMouse();	
		Cubes.add(new Cube(18, -5, 0, 2, 2, 2, Color.green));
		Cubes.add(new Cube(18, -8, 0, 2, 2, 2, Color.red));
		Cubes.add(new Cube(22, -5, 0, 3, 2, 3, Color.white));
		Cubes.add(new Cube(22, -8, 0, 3, 2, 3, Color.orange));
                
                Spheres.add(new Sphere(0,0,0,1, new Color(200, 150, 100)));
	}	
	...
	public void paintComponent(Graphics g)
	{
		...
		g.fillRect(0, 0, (int)ProjektII.ScreenSize.getWidth(), (int)ProjektII.ScreenSize.getHeight());
		...
		g.drawString("FPS: " + (int)drawFPS + "", 40, 40);
                g.drawString("Stopień wypolerowania: " + n + "", 40, 55);
                g.drawString("Światło rozproszone " + kd + "", 40, 70);
                g.drawString("Światło otoczenia: " + ka + "", 40, 85);
                g.drawString("RGB: " + c.getRed() + " "+ c.getGreen() +" "+ c.getBlue()+ "", 40, 100);
...
//		System.out.println(repaintTime);
	...
	void drawMouseAim(Graphics g)
	{
		...
		g.drawLine((int)(ProjektII.ScreenSize.getWidth()/2 - aimSight), (int)(ProjektII.ScreenSize.getHeight()/2), (int)(ProjektII.ScreenSize.getWidth()/2 + aimSight), (int)(ProjektII.ScreenSize.getHeight()/2));
		g.drawLine((int)(ProjektII.ScreenSize.getWidth()/2), (int)(ProjektII.ScreenSize.getHeight()/2 - aimSight), (int)(ProjektII.ScreenSize.getWidth()/2), (int)(ProjektII.ScreenSize.getHeight()/2 + aimSight));			
	}
	...
	{		
			double difX = (NewMouseX - ProjektII.ScreenSize.getWidth()/2);
			double difY = (NewMouseY - ProjektII.ScreenSize.getHeight()/2);
	...
	void CenterMouse() 
	{
			try {
				r = new Robot();
				r.mouseMove((int)ProjektII.ScreenSize.getWidth()/2, (int)ProjektII.ScreenSize.getHeight()/2);
        ...
        static int n =1;
        static double kd = 0.5, ka =0.5;
        static Color c = new Color(200, 100, 50);
		...
		if(e.getKeyCode() == KeyEvent.VK_ESCAPE)
			System.exit(0);
                ...
                if(e.getKeyCode() == KeyEvent.VK_F7){
                    if (c.getRed() > 0) c = new Color(c.getRed() -1, c.getGreen(), c.getBlue());
                }
                if(e.getKeyCode() == KeyEvent.VK_F8){
                    if (c.getRed() < 255) c = new Color(c.getRed() +1, c.getGreen(), c.getBlue());
                }
                if(e.getKeyCode() == KeyEvent.VK_F9){
                    if (c.getGreen() > 0) c = new Color(c.getRed(), c.getGreen() -1, c.getBlue());
                }
                if(e.getKeyCode() == KeyEvent.VK_F10){
                    if (c.getGreen() < 255) c = new Color(c.getRed(), c.getGreen() +1, c.getBlue());
                }
                if(e.getKeyCode() == KeyEvent.VK_F11){
                    if (c.getBlue() > 0) c = new Color(c.getRed(), c.getGreen(), c.getBlue() -1);
                }
                if(e.getKeyCode() == KeyEvent.VK_F12){
                    if (c.getBlue() < 255) c = new Color(c.getRed(), c.getGreen(), c.getBlue()+1);
                }
